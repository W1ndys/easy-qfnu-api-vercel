...
func GetClassSchedules(c *gin.Context) {
	...
	if err := c.ShouldBindQuery(&req); err != nil {
		log.Warn("课程表查询参数绑定失败", zap.Error(err))
